...
/* The 16 hardware-IRQ stubs (kernel/irq_stubs.asm), mapped to vectors 32..47 (B6). */
...
void idt_init(void)
{
    ...
    /* B6: hardware IRQs at vectors 32..47 (the PIC is remapped to match). */
    void (*irqs[16])(void) = {
        irq0,  irq1,  irq2,  irq3,  irq4,  irq5,  irq6,  irq7,
        irq8,  irq9,  irq10, irq11, irq12, irq13, irq14, irq15,
    };
    for (int i = 0; i < 16; i++)
        set_gate(32 + i, (uint32_t)irqs[i]);
